...
describe('Login Component', () => {
  it('should render login page with branding', () => {
    ...
    expect(screen.getByText('ARGBOT')).toBeInTheDocument();
  ...
  it('should display "No hay contraseñas" message', () => {
    ...
    expect(screen.getByText(/Sin contraseñas adicionales/)).toBeInTheDocument();
  });
  ...
  it('should close updates modal when close button is clicked', () => {
    ...
    const closeButton = screen.getByText('Close Updates');
  ...
  it('should close legal modal when close button is clicked', () => {
    ...
    const closeButton = screen.getByText('Close Legal');
    fireEvent.click(closeButton);
  ...
  it('should display version number', () => {
    ...
    expect(screen.getByText('v1.8.158')).toBeInTheDocument();
  });
});
